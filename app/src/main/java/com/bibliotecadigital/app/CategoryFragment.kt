...
class CategoryFragment : Fragment() {
    ...
    private fun setupRecyclerView() {
        val allBooks = listOf(
            ...
            Book("5", "Harry Potter", "J.K. Rowling", "Fantasia", "", 4, 4, "reserved", "9780439708180", "", "Scholastic", "1997"),
            Book("6", "A Menina que Roubava Livros", "Markus Zusak", "Drama", "", 1, 1, "available", "9788539003839", "", "Intrínseca", "2005"),
            Book("7", "O Hobbit", "J.R.R. Tolkien", "Fantasia", "", 2, 2, "available", "9788578277109", "", "Martins Fontes", "1937"),
            Book("8", "Fundação", "Isaac Asimov", "Ficção Científica", "", 3, 3, "available", "9788576571551", "", "Editora Aleph", "1951"),
            Book("9", "Memórias Póstumas", "Machado de Assis", "Clássico", "", 4, 4, "available", "9788525406033", "", "L&PM", "1881"),
            Book("10", "Alice no País das Maravilhas", "Lewis Carroll", "Infantil", "", 5, 5, "available", "9788573266382", "", "Editora 34", "1865")
        )
