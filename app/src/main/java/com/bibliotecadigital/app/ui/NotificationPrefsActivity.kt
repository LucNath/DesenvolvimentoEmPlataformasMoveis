...
class NotificationPrefsActivity : AppCompatActivity() {
    ...
    private fun setupPreviews() {
        ...
        binding.previewLoans.viewUnreadIndicator.visibility = View.VISIBLE
        ...
        binding.previewReservations.viewUnreadIndicator.visibility = View.VISIBLE
        ...
        binding.previewEvents.viewUnreadIndicator.visibility = View.VISIBLE
    }
